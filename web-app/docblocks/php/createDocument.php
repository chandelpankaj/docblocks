...
<div class="container">
  ...
  <form action="">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" id="documentFile" placeholder="Select Document File" name="documentFile">
    </div>
    
    <button type="submit" class="btn btn-default" onclick="return createDocument()">Submit</button>
  </form>
</div>



<script src="../js/createDocument.js"></script>
</body>
</html>
