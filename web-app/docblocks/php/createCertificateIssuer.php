...
<div class="container">
  <h2>Create Certificate Issuer</h2>
  <form action="">
    ...
    <button type="submit" class="btn btn-default" onclick="return createCertificateIssuer()">Submit</button>
  </form>
</div>



<script src="../js/createCertificateIssuer.js"></script>
</body>
</html>
